...
std::initializer_list<std::pair<BWAPI::UnitType, int>> protoss_smallest = {
...
std::initializer_list<std::pair<BWAPI::UnitType, int>> protoss_medium = {
    {BWAPI::UnitType::Zerg_Drone, 8},
    {BWAPI::UnitType::Zerg_Drone, 10},
    ...
    {BWAPI::UnitType::Zerg_Zergling, 28}
}
    
// 12 hatch on large maps
// https://liquipedia.net/starcraft/12_Hatch_(vs._Protoss)
std::initializer_list<std::pair<BWAPI::UnitType, int>> protoss_large = {
    {BWAPI::UnitType::Zerg_Drone, 8},
    {BWAPI::UnitType::Zerg_Drone, 10},
    {BWAPI::UnitType::Zerg_Drone, 12},
    {BWAPI::UnitType::Zerg_Drone, 14},
