...
extern const std::initializer_list<std::pair<BWAPI::UnitType, int>> unknown_smallest = {
...
extern const std::initializer_list<std::pair<BWAPI::UnitType, int>> unknown_medium = {
    {BWAPI::UnitTypes::Zerg_Drone, 8},
    {BWAPI::UnitTypes::Zerg_Drone, 10},
...
extern const std::initializer_list<std::pair<BWAPI::UnitType, int>> unknown_large = {
    {BWAPI::UnitTypes::Zerg_Drone, 8},
    {BWAPI::UnitTypes::Zerg_Drone, 10},
    {BWAPI::UnitTypes::Zerg_Drone, 12},
    {BWAPI::UnitTypes::Zerg_Drone, 14},
